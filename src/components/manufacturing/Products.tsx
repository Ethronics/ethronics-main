...
function ProgressBar({ targetProgress, isVisible }: { targetProgress: number; isVisible: boolean }) {
    ...
    return (
      <div className="w-full">
        ...
        {isComplete && (
          <p className="text-white mt-1 text-center">{targetProgress}% Complete</p>
        )}
      </div>
    );
  }

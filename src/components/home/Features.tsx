        ...
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            cards.forEach((card, index) => {
              ...
              // Set a delay based on the card's index to create the wave effect
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {researchFeatures.map((feature: Feature, index) => (
            <div
              key={index}
              className="feature-card p-6 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors text-center"
            >

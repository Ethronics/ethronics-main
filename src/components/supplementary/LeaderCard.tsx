...
export interface Leader {
  name: string;
  quote: string; // Subtitle quote about tech or life
  bio: string;
  position: string; // Current position at Ethronics
  image: string;
  achievements: string[];
  ...
  return (
    <>
      ...
      >
        ...
        <h3 className="text-xl md:text-2xl font-bold text-white mb-1 text-center">
          {name}
        </h3>
        <p className="text-md md:text-lg text-purple-300 font-medium mb-3 text-center tracking-wide italic">
          "{quote}"
        </p>
        <p className="text-gray-300 text-sm md:text-base mb-4 text-center leading-relaxed line-clamp-3">
          {bio}
        </p>
        <div className="text-sm text-gray-400 text-center">
          <p>
            <strong className="font-semibold text-gray-200">Position:</strong>{" "}
            {position}
          </p>
        </div>
      </div>
        ...
        >
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <p className="text-lg text-purple-300 mb-4 italic">"{quote}"</p>
              <p className="text-gray-300 text-base mb-4 text-center">{bio}</p>
